...
class ObjectSegmentationDataset(Dataset):
    """
    Dataset class for training model for object segmentation task.
    ...
    def __init__(self,
        ...
        self._extension_input = ["-transparent-rgb-img.jpg", "-rgb.jpg", "-rgb.png"]  # The file extension of input images
